...
import { mockPromotions, mockServices } from '@/app/(main)/lib/data';
...
import { Switch } from '@/app/(main)/components/switch';
import {
  Dialog,
  DialogContent,
  DialogDescription,
  ...
  DialogTitle,
  DialogTrigger,
} from '@/app/(main)/components/dialog';
import {
  Select,
  SelectContent,
  SelectItem,
  SelectTrigger,
  SelectValue,
} from '@/app/(main)/components/select';
import { Checkbox } from '@/app/(main)/components/checkbox';
import { Plus, Edit, Trash2, Gift, Percent } from 'lucide-react';
import { Promotion } from '@/app/(main)/types';
